...
def start_scheduler() -> None:
    scheduler.add_job(check_bill_reminders, CronTrigger(hour=8, minute=0), id="bill-reminders", replace_existing=True)
    scheduler.add_job(check_budget_alerts, CronTrigger(hour=9, minute=0), id="budget-alerts", replace_existing=True)
